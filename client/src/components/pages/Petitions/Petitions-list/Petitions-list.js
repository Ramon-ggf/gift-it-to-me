...
export default class PetitionsList extends Component {
    constructor() {
        ...
        this.state = { petitions: undefined }
    ...
    refreshPetitions = () => {
        ...
        if (this.props.location.pathname.includes('/profile/mypetitions') && (this.props.user.role === 'GIVER' || this.props.user.role === 'RECEIVER')) {

            this.petitionService
                .getOwnPets(this.props.user._id)
